/*
 ...
 Source Server         : fatpaper.site
 Source Server Type    : MySQL
 Source Server Version : 80300
 Source Host           : fatpaper.site:3307
...
-- ----------------------------
INSERT INTO `arrived_event` VALUES ('350573c5-7af5-49a8-9949-5b3eea57f93f', '意外之财', '从管理员口袋里掏2000块', 'fatpaper-1304992673.cos.ap-guangzhou.myqcloud.com/monopoly/arrived_event_icons/6a6f158fec301cfa07427861457e2586.png', 'arrivedPlayer.gain(2000);');
INSERT INTO `arrived_event` VALUES ('749bae19-4f4a-420b-94ba-b0eb3932504a', '末地的馈赠', '随机获得一张卡片', 'fatpaper-1304992673.cos.ap-guangzhou.myqcloud.com/monopoly/arrived_event_icons/492e0952c735604cefb82a175501fb13.png', 'arrivedPlayer.gainCard(1);');
INSERT INTO `arrived_event` VALUES ('7748876a-1a5f-4bbe-ba96-242fbb19198a', '哇！是公园', '来都来了，睡一会（一个回合）', 'fatpaper-1304992673.cos.ap-guangzhou.myqcloud.com/monopoly/arrived_event_icons/89d2e7cc2ad186f2424f575b0b7f016a.png', 'arrivedPlayer.setStop(1);');
INSERT INTO `arrived_event` VALUES ('d0484a28-75c9-4b16-9058-fbb586962526', '前面有免费鸡蛋', '踩到的玩家看到前面有免费的鸡蛋，不由自主地往前进1~3步', 'fatpaper-1304992673.cos.ap-guangzhou.myqcloud.com/monopoly/arrived_event_icons/7281a6babe870c9df060500f8d2db579.png', 'await arrivedPlayer.walk(Math.floor(Math.random()*3)+1);\r\n	await gameProcess.handleArriveEvent(arrivedPlayer);');
INSERT INTO `arrived_event` VALUES ('f1476eef-f5a3-4097-b7fe-98651fed9ef6', '洗牌', '踩到此格子的玩家会失去所有机会卡，然后获得等量的随机新机会卡', 'fatpaper-1304992673.cos.ap-guangzhou.myqcloud.com/monopoly/arrived_event_icons/d3b397e42a7436dbb69432346fb28052.png', 'const num = arrivedPlayer.getCardsList().length;\r\n	arrivedPlayer.setCardsList([]);\r\n	arrivedPlayer.gainCard(num);');
...
INSERT INTO `chance_card` VALUES ('6a4ddac7-cf1c-403a-bf5a-5d26f3c2910b', '施舍', '给目标1块钱（you bad bad）', 'fatpaper-1304992673.cos.ap-guangzhou.myqcloud.com/monopoly/chance_card_icons/bb9f5a3eafcf98f062d57948c59c4051.png', 'rgb(253, 181, 21)', 'ToOtherPlayer', 'sourcePlayer.cost(1);\r\n	target.gain(1);');
...
INSERT INTO `map_item` VALUES ('62378ae8-84fd-4a74-ab26-6dd80bc8c17a', 'item-11-9', 11, 9, 0, '201873e1-d77e-4513-9d1f-e569c7a385c7', NULL, NULL, 'f1476eef-f5a3-4097-b7fe-98651fed9ef6', 'd01a06c2-fef1-4350-bcc3-986e44325275');
...
INSERT INTO `map_item` VALUES ('aa72b756-12cf-45e8-b4ab-6e590df50c6a', 'item-6-11', 6, 11, 0, '1c808dd7-b050-4273-9d72-deb060f2f6d1', NULL, NULL, '749bae19-4f4a-420b-94ba-b0eb3932504a', 'd01a06c2-fef1-4350-bcc3-986e44325275');
INSERT INTO `map_item` VALUES ('b0ae9eed-82c8-4099-8f2e-329057c97d0a', 'item-14-9', 14, 9, 2, '1c808dd7-b050-4273-9d72-deb060f2f6d1', NULL, NULL, '350573c5-7af5-49a8-9949-5b3eea57f93f', 'd01a06c2-fef1-4350-bcc3-986e44325275');
INSERT INTO `map_item` VALUES ('b27c2da7-eb49-4faa-a915-c65cde4bf4a1', 'item-9-11', 9, 11, 0, '201873e1-d77e-4513-9d1f-e569c7a385c7', NULL, NULL, '350573c5-7af5-49a8-9949-5b3eea57f93f', 'd01a06c2-fef1-4350-bcc3-986e44325275');
...
INSERT INTO `map_item` VALUES ('d184a4e2-d51c-468e-b33f-ead8893d20d1', 'item-14-13', 14, 13, 0, '53c18321-82a8-4b50-8efb-f067920eb5da', NULL, NULL, 'd0484a28-75c9-4b16-9058-fbb586962526', 'd01a06c2-fef1-4350-bcc3-986e44325275');
